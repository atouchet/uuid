...
If you'd like to parse UUIDs _really_ fast, check out the
[`uuid-simd`](https://github.com/Nugine/simd) library.

For more details on using `uuid`,
[see the library documentation](https://docs.rs/uuid/1.21.0/uuid/).
